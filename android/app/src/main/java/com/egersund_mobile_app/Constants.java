...
public final class Constants {
    ...
    public final static int CORNER_RADIUS = 100;
    public final static String BILL_NUMBER = "123";
    public final static boolean ALLOW_PRE_AUTH = false;
    public final static String ATTR_1_PHONE = "P";
    public final static String ATTR_1_ACCOUNT = "A";
